...
#CLI
```bash
universal-parse --repo-path /Users/anhnh/Documents/vscode/deepwiki-agent-universal-parser/src/data/repos/titan-sight --max-concurrent 5 --output-dir /Users/anhnh/Documents/vscode/deepwiki-agent-universal-parser/volume
```
